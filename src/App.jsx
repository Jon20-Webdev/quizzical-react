...
function App() {
  ...
  const shuffleArray = (arr) => arr.sort(() => Math.random() - 0.5); // this is from https://blog.bitsrc.io/5-javascript-one-liners-to-save-your-day-82a065d05017

  useEffect(() => {     // Initializing and fetching the question from the open trivia database
    async function getQuestion() {
      ...
      let q = []
      data.results.forEach(question =>{   //Push each properties to return the questions, answer, id props. to the components
          q.push({
              id: nanoid(),
